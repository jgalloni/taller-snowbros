...
ServicioFabricaDeObjetos * LocalizadorDeServicios::proveedorServicioFabrica = NULL;
...
// Devuelve el objeto encargado de proveer informacion publica.
ServicioFabricaDeObjetos * LocalizadorDeServicios::obtenerFabricaDeObjetos(){
	return proveedorServicioFabrica;
}

// Asigna a 'proveedor' como el objeto que se encargara de proveer
// informacion publica
void LocalizadorDeServicios::proveer(ServicioFabricaDeObjetos * proveedor){
	proveedorServicioFabrica = proveedor;
}
